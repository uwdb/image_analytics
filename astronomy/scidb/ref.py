...
def main():
    ...
    #visits = ["0288935", "0288976","0289893","0289913","0289931","0289614","0289818","0289820", "0289850","0289851","0289871","0289892", "0288935","0288976","0289016","0289056","0289161","0289202","0289243","0289284","0289368","0289409","0289450","0289493","0289697","0289783","0289573","0289656"]
    ...
    DATA_PATH = "/home/ubuntu/lsst_data/"
    ...
    for v in visits:
        #DFZ: create the directories
        from subprocess import call
        call(["mkdir", "-p", calexpsloc+v])
        ...
        for ccd in ccds:
            ...
            try:
                ...
                f.write("DFZ DEBUG 148: errors in visit " + v + ", ccd " + str(ccd) + "\n")
            ...
            try:
                ...
                f.write("DFZ DEBUG 155: errors in visit " + v + ", ccd " + str(ccd) + "\n")
            ...
            try:
                ...
                f.write("DFZ DEBUG 162: errors in visit " + v + ", ccd " + str(ccd) + "\n")
    #
    ...
    print "length of ccds per patch list: "+str(len(ccdsPerPatch))
    # #import cPickle
    ...
    for visit in visits:
        ...
        for a in dfgby.indices:
            ...
            for b in dfgby.get_group(a)[0].ravel():
                ...
                numGoodPix = 0
                ccd = b
                print "ccd being added: " + str(ccd) + "; visit " + visit
                filename  = "instcal"+visit+"."+str(ccd)+".fits"
                source   = calexpsloc + visit+ "/"+filename
...
#DFZ: stop here for SciDB input
    ...
    for a in dfgby.indices:
        ...
        xInd = a[0]
        yInd = a[1]
        print "Processing patch: "+str(xInd) +","+ str(yInd)
        print "number of coadds to process: " + str(len(coaddTempExpDict[a]))
