...
iquery -anq "store(stream(PATCHES, '
...
export APR_UTIL_DIR=/home/ubuntu/lsst_stack/Linux64/apr_util/1.5.4;
    /home/ubuntu/lsst_stack/Linux64/miniconda2/3.19.0.lsst4/bin/python /home/ubuntu/scidb_lsst/stream_coadd.py
'), lsst_streamout_coadd)"
